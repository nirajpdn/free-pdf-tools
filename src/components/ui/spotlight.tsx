...
export function SpotLightItem({ children, className }: SpotlightItemProps) {
  ...
  return (
    <div
      ...
      className={cn(
        className,
        " relative  rounded-lg p-0.5 bg-[#ffffff15] overflow-hidden",
      )}
    >
      {isHovered && (
        <div
...
export const SpotLightWithMotion = motion(Spotlight);

export const SpotLightItemWithMotion = motion(SpotLightItem);
